...
API_REFERENCE: dict[str, dict[str, Any]] = {
    "/text-to-speech": {
        ...
        "request_body": {
            "text":                 "str, required — text to synthesize (official SDK field)",
            "inputs":               "list[str], legacy — accepted for compatibility; prefer `text`",
            "target_language_code": "str, required — one of TTS-supported codes",
            "speaker":              "str — must be compatible with chosen model (default shubh/priya)",
            "model":                "str — bulbul:v3 default",
            "speech_sample_rate":   "int — 8000|16000|22050|24000|32000|44100|48000",
            "pace":                 "float — v3: 0.5–2.0; v2: 0.3–3.0 (default 1)",
            "temperature":          "float — v3 only, 0.01–2.0 (default 0.6)",
            "pitch":                "float — bulbul:v2 only; ignored on v3",
            "loudness":             "float — bulbul:v2 only; ignored on v3",
            "enable_preprocessing": "bool — bulbul:v2 only; v3 preprocesses automatically",
        },
        "response": {
            "audios":     "list[str] — base64-encoded WAV",
            "request_id": "str",
        },
        "notes": "Use `text` (not `inputs`). Pick a speaker via sarvam_code_speakers. Omit pitch/loudness on bulbul:v3.",
    },
    "/speech-to-text": {
        "method": "POST",
